...
const resolveOptionValue = (option) => {
  ...
  return option.code || option.key || option.label || option.name || '';
};
...
const CustomSearchDropdown = ({
  ...
  const resolvedPlaceholder = placeholder || (
    multiple
      ? formatMessage(messages.multiselectPlaceholder)
  ...
  return (
    <div
      className={`custom-search-dropdown ${isOpen ? 'is-open' : ''} ${className || ''}`}
      ref={wrapperRef}
